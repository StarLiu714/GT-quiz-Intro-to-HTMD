...
1. **Which of these is least important in computational high-throughput screening of materials?**
...
1. **Which of these aspects has received greatest attention to date in engineering practice?**
...
1. **Material structure hierarchy refers to**
...
1. **Concurrent materials and product design**
...
1. **One of the primary driving forces for accelerated discovery and development of materials is:**
...
1. **Historical materials discovery and development was largely:**
...
1. **The U.S. Materials Genome Initiative seeks to accelerate materials development by \_\_\_\_\_\_\_\_\_\_ phases of development, certification, manufacturing and deployment.**

Parallelizing

Serializing

1. **The Materials Innovation Ecosystem**
...
1. **The complexity of materials discovery is due to**
...
1. **How can HTMD accelerate development?**
...
1. **Which of the following is an early 20th century example of HTMD?**
...
1. **In his 'Multiple sample concept' paper, how did Hanak cover a large composition range in single experiment?**
...
1. **The company Symyx was formed around the time of the publication of which HTMD landmark paper?**
...
1. **How was the library investigating polymer wetting built in the work reported by Meredith, Smith, Karim, Amis in Macromolecules 2000 33, 9747?**
...
1. **Which important material was obtained by Kohn in 2004 through HTMD polymeric materials?**

1st degradable, radio-opaque stent

1. **Two general goals of HTMD are materials discovery and knowledge discovery.**

True

1. **Which of the following libraries are used in HTMD?**
...
1. **Combinatorial physical vapor deposited thin film libraries prepared on DIFFERENT substrates will have identical microstructures and properties.**

False

1. **Producing thin film combinatorial material libraries of varying composition is easier with physical vapor deposition methods than with chemical vapor deposition methods.**

True

1. **How does the flux from a physical vapor deposition process vary with distance (r) from a point source?**

1/(r^2)

1. **When comparing sputtering to evaporation:**
...
1. **Which of the following physical vapor deposition methods produces a discrete combinatorial library of material compositions?** 

Masked Deposition

1. **What challenge is presented when a compositional combinatorial library is prepared by vapor depositing thin films through a series of shadow masks?**
...
1. **Which of the following is NOT true about the physical vapor deposition of thin films:**
...
1. **Upset forging relies on varying the quench rate in order to create microstructure gradients.**

False

1. **Which of these processes are controlled for the solution treatment and aging process?**
...
1. **Rapid Alloy Prototyping (RAP) typically takes more than one day to complete.**

True

1. **Which of these statements about RAP are true?**
...
1. **Alloy properties that depend on microstructure include**
...
1. **The most effective additive manufacturing methods to generate materials libraries include:**
...
1. **A material library is a collection of samples with variations in attributes, such as:** 
...
1. **What is varied in the the library of atom transfer radical polymerization published by Zhang et al., *Macromol. Rapid Comm.* 2003 24, 81?**
...
1. **What is varied in the polymer melt processing library described by Potyrailo et al., Macro. Rap. Comm. 2003 24, 123, using a microextruder system?** 
...
1. **Which of the following spectroscopic methods was used to determine the PCL/PDLA compositions in the library discussed in this module?**
...
1. **What is typically included in the polymer chemical structure?**
...
1. **What is the standard tool to determine molecule size of polymer?**
...
1. **In studying the crystallinity in thin polymer films, what parameters are used to create the library?**
...
1. **Which of these methods can possibly be used to identity a phase transformation?**
...
1. **Which of these methods can be used to determine the composition of inorganic material libraries?**
...
1. **Which of these methods can be used to determine the crystal structure of inorganic material libraries?**
...
1. **Which of these methods is based on measuring the thermal response to identify a phase transformation?**
...
1. **For identifying the crystal structure of inorganic materials, XRD has \_\_\_\_\_\_\_\_\_ than EBSD.**
...
1. **What type of materials for displays have been explored with HTMD?**
...
1. **What is the type of library used for the discovery of the superconducting materials in the paper of Xiang et al., *Science* 1995 *268*, 1738?**
...
1. **What does the HTMD indenter testing directly measure?**
...
1. **Which of the following comments are true for catalysis of chemical reactions?**
...
1. **Which of the follow definitions are true?**
...
Protein adsorption of Al1-*x*Ti*x* and Al1-*x*Nb*x* is affected by their structure gradient.

Adsorption is defined as molecules attaching to a surface

1. **Which techniques can be used for high-throughput characterization of protein adsorption?**
...
1. **Biological properties in HTMD typically involve:**
...
1. **What libraries were created for the example study of osteoblasts cell adhesion on blend polymers of poly(DL-lactide) and poly(caprolactone)?**
...
1. **Which of these methods is best suited for high-throughput yield strength measurements?**
...
1. **The elastic modulus is proportional to :** 
...
1. **For high-throughput property measurements, which of these attributes is the least critical?**
...
1. **Which one of these is not accomplished by the zero point correction discussed in Kalidindi and Pathak, Acta Materialia 2008 56, 3523?**
...
1. **Identify the true statements regarding high-throughput fracture toughness tests using indentation.**
...
1. **The size of the indenter, as long as the tip geometry remains the same, does not affect the property measurement.**
...
1. **What is varied in the libraries designed for proton exchange membranes?**
...
1. **Which of the following comments on AC impedance spectroscopy is false?**
...
1. **HTC screening studies of PVDF/SEM-HEMA membranes indicates the strong influences of Kynar type. How correlations in structure-property relationship is discovered?**
...
1. **Precipitate nucleation and growth is more likely if free energy of compound formation is less than free energy of mixing.**

**True**

1. **Which of these influence whether an intermetallic phase will be formed?**
...
1. **Which of the statements about the assessment of alloys is incorrect?**
...
1. **After you have identified the palette of elements and have screened using high-throughput computational calculations, what is the next step in the HTMD strategy for alloy development?**
...
1. **Which stage of the high-throughput evaluation process involves calculation of phase equilibria for any given system of elements?**
...
1. **In "Step 1: Identify palette of elements,", what conditions are criteria for selecting the** 
...
1. **Near the melting point, configurational entropy primarily depends on the gas constant and what?**
...
1. **The likely best step to evaluate the oxidation resistance in the HTMD strategy for high temperature alloy development is:**
...
1. **Examples of high-throughput computational calculations used for screening include:**
...
1. In the HT indentation testing, spherical indenter was used instead of a sharp indentation because (select all correct answers):
...
1. Which are true statements regarding indentation measurement on the dual phase steel considered in this case study?
...
1. Choose the statements that are true for high-throughput prototyping protocols:
...
1. In this case study, the first two PCs, PC1 and PC2, correlated well to (select all correct answers):
